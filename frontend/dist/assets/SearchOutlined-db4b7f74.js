...
`,[R("scrollbar",`
 ...
 text-overflow: ellipsis;
 overflow: hidden;
 `)])])]),Vt=ue({name:"InternalSelection",props:Object.assign(Object.assign({},Oe.props),{clsPrefix:{type:String,required:!0},bordered:{type:Boolean,default:void 0},active:Boolean,pattern:{type:String,default:""},placeholder:String,selectedOption:{type:Object,default:null},selectedOptions:{type:Array,default:null},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},multiple:Boolean,filterable:Boolean,clearable:Boolean,disabled:Boolean,size:{type:String,default:"medium"},loading:Boolean,autofocus:Boolean,showArrow:{type:Boolean,default:!0},inputProps:Object,focused:Boolean,renderTag:Function,onKeydown:Function,onClick:Function,onBlur:Function,onFocus:Function,onDeleteOption:Function,maxTagCount:[String,Number],ellipsisTagPopoverProps:Object,onClear:Function,onPatternInput:Function,onPatternFocus:Function,onPatternBlur:Function,renderLabel:Function,status:String,inlineThemeDisabled:Boolean,ignoreComposition:{type:Boolean,default:!0},onResize:Function}),setup(e){const{mergedClsPrefixRef:l,mergedRtlRef:s}=ln(e),d=wn("InternalSelection",s,l),c=M(null),v=M(null),f=M(null),i=M(null),C=M(null),z=M(null),p=M(null),$=M(null),O=M(null),w=M(null),b=M(!1),k=M(!1),V=M(!1),T=Oe("InternalSelection","-internal-selection",Lt,Sn,e,j(e,"clsPrefix")),S=B(()=>e.clearable&&!e.disabled&&(V.value||e.active)),P=B(()=>e.selectedOption?e.renderTag?e.renderTag({option:e.selectedOption,handleClose:()=>{}}):e.renderLabel?e.renderLabel(e.selectedOption,!0):Fe(e.selectedOption[e.labelField],e.selectedOption,!0):e.placeholder),I=B(()=>{const t=e.selectedOption;if(t)return t[e.labelField]}),E=B(()=>e.multiple?!!(Array.isArray(e.selectedOptions)&&e.selectedOptions.length):e.selectedOption!==null);function U(){var t;const{value:h}=c;if(h){const{value:N}=v;N&&(N.style.width=`${h.offsetWidth}px`,e.maxTagCount!=="responsive"&&((t=O.value)===null||t===void 0||t.sync({showAllItemsBeforeCalculate:!1})))}}function W(){const{value:t}=w;t&&(t.style.display="none")}function oe(){const{value:t}=w;t&&(t.style.display="inline-block")}be(j(e,"active"),t=>{t||W()}),be(j(e,"pattern"),()=>{e.multiple&&xn(U)});function ie(t){const{onFocus:h}=e;h&&h(t)}function Q(t){const{onBlur:h}=e;h&&h(t)}function J(t){const{onDeleteOption:h}=e;h&&h(t)}function Y(t){const{onClear:h}=e;h&&h(t)}function A(t){const{onPatternInput:h}=e;h&&h(t)}function X(t){var h;(!t.relatedTarget||!(!((h=f.value)===null||h===void 0)&&h.contains(t.relatedTarget)))&&ie(t)}function he(t){var h;!((h=f.value)===null||h===void 0)&&h.contains(t.relatedTarget)||Q(t)}function se(t){Y(t)}function Te(){V.value=!0}function le(){V.value=!1}function me(t){!e.active||!e.filterable||t.target!==v.value&&t.preventDefault()}function K(t){J(t)}const Z=M(!1);function o(t){if(t.key==="Backspace"&&!Z.value&&!e.pattern.length){const{selectedOptions:h}=e;h!=null&&h.length&&K(h[h.length-1])}}let u=null;function D(t){const{value:h}=c;if(h){const N=t.target.value;h.textContent=N,U()}e.ignoreComposition&&Z.value?u=t:A(t)}function re(){Z.value=!0}function we(){Z.value=!1,e.ignoreComposition&&A(u),u=null}function xe(t){var h;k.value=!0,(h=e.onPatternFocus)===null||h===void 0||h.call(e,t)}function ae(t){var h;k.value=!1,(h=e.onPatternBlur)===null||h===void 0||h.call(e,t)}function q(){var t,h;if(e.filterable)k.value=!1,(t=z.value)===null||t===void 0||t.blur(),(h=v.value)===null||h===void 0||h.blur();else if(e.multiple){const{value:N}=i;N==null||N.blur()}else{const{value:N}=C;N==null||N.blur()}}function ye(){var t,h,N;e.filterable?(k.value=!1,(t=z.value)===null||t===void 0||t.focus()):e.multiple?(h=i.value)===null||h===void 0||h.focus():(N=C.value)===null||N===void 0||N.focus()}function de(){const{value:t}=v;t&&(oe(),t.focus())}function Re(){const{value:t}=v;t&&t.blur()}function Me(t){const{value:h}=p;h&&h.setTextContent(`+${t}`)}function Pe(){const{value:t}=$;return t}function ze(){return v.value}let fe=null;function ve(){fe!==null&&window.clearTimeout(fe)}function ke(){e.active||(ve(),fe=window.setTimeout(()=>{E.value&&(b.value=!0)},100))}function _e(){ve()}function $e(t){t||(ve(),b.value=!1)}be(E,t=>{t||(b.value=!1)}),en(()=>{rt(()=>{const t=z.value;t&&(e.disabled?t.removeAttribute("tabindex"):t.tabIndex=k.value?-1:0)})}),yn(f,e.onResize);const{inlineThemeDisabled:Ce}=e,ge=B(()=>{const{size:t}=e,{common:{cubicBezierEaseInOut:h},self:{fontWeight:N,borderRadius:je,color:We,placeholderColor:Ee,textColor:Ae,paddingSingle:De,paddingMultiple:Ke,caretColor:Ue,colorDisabled:Ne,textColorDisabled:ce,placeholderColorDisabled:n,colorActive:r,boxShadowFocus:g,boxShadowActive:F,boxShadowHover:x,border:m,borderFocus:y,borderHover:L,borderActive:ee,arrowColor:On,arrowColorDisabled:Tn,loadingColor:Rn,colorActiveWarning:Mn,boxShadowFocusWarning:Pn,boxShadowActiveWarning:zn,boxShadowHoverWarning:kn,borderWarning:_n,borderFocusWarning:$n,borderHoverWarning:Bn,borderActiveWarning:In,colorActiveError:En,boxShadowFocusError:An,boxShadowActiveError:Dn,boxShadowHoverError:Nn,borderError:Ln,borderFocusError:Vn,borderHoverError:Hn,borderActiveError:jn,clearColor:Wn,clearColorHover:Kn,clearColorPressed:Un,clearSize:qn,arrowSize:Gn,[pe("height",t)]:Qn,[pe("fontSize",t)]:Jn}}=T.value,Le=Be(De),Ve=Be(Ke);return{"--n-bezier":h,"--n-border":m,"--n-border-active":ee,"--n-border-focus":y,"--n-border-hover":L,"--n-border-radius":je,"--n-box-shadow-active":F,"--n-box-shadow-focus":g,"--n-box-shadow-hover":x,"--n-caret-color":Ue,"--n-color":We,"--n-color-active":r,"--n-color-disabled":Ne,"--n-font-size":Jn,"--n-height":Qn,"--n-padding-single-top":Le.top,"--n-padding-multiple-top":Ve.top,"--n-padding-single-right":Le.right,"--n-padding-multiple-right":Ve.right,"--n-padding-single-left":Le.left,"--n-padding-multiple-left":Ve.left,"--n-padding-single-bottom":Le.bottom,"--n-padding-multiple-bottom":Ve.bottom,"--n-placeholder-color":Ee,"--n-placeholder-color-disabled":n,"--n-text-color":Ae,"--n-text-color-disabled":ce,"--n-arrow-color":On,"--n-arrow-color-disabled":Tn,"--n-loading-color":Rn,"--n-color-active-warning":Mn,"--n-box-shadow-focus-warning":Pn,"--n-box-shadow-active-warning":zn,"--n-box-shadow-hover-warning":kn,"--n-border-warning":_n,"--n-border-focus-warning":$n,"--n-border-hover-warning":Bn,"--n-border-active-warning":In,"--n-color-active-error":En,"--n-box-shadow-focus-error":An,"--n-box-shadow-active-error":Dn,"--n-box-shadow-hover-error":Nn,"--n-border-error":Ln,"--n-border-focus-error":Vn,"--n-border-hover-error":Hn,"--n-border-active-error":jn,"--n-clear-size":qn,"--n-clear-color":Wn,"--n-clear-color-hover":Kn,"--n-clear-color-pressed":Un,"--n-arrow-size":Gn,"--n-font-weight":N}}),H=Ce?rn("internal-selection",B(()=>e.size[0]),ge,e):void 0;return{mergedTheme:T,mergedClearable:S,mergedClsPrefix:l,rtlEnabled:d,patternInputFocused:k,filterablePlaceholder:P,label:I,selected:E,showTagsPanel:b,isComposing:Z,counterRef:p,counterWrapperRef:$,patternInputMirrorRef:c,patternInputRef:v,selfRef:f,multipleElRef:i,singleElRef:C,patternInputWrapperRef:z,overflowRef:O,inputTagElRef:w,handleMouseDown:me,handleFocusin:X,handleClear:se,handleMouseEnter:Te,handleMouseLeave:le,handleDeleteOption:K,handlePatternKeyDown:o,handlePatternInputInput:D,handlePatternInputBlur:ae,handlePatternInputFocus:xe,handleMouseEnterCounter:ke,handleMouseLeaveCounter:_e,handleFocusout:he,handleCompositionEnd:we,handleCompositionStart:re,onPopoverUpdateShow:$e,focus:ye,focusInput:de,blur:q,blurInput:Re,updateCounter:Me,getCounter:Pe,getTail:ze,renderLabel:e.renderLabel,cssVars:Ce?void 0:ge,themeClass:H==null?void 0:H.themeClass,onRender:H==null?void 0:H.onRender}},render(){const{status:e,multiple:l,size:s,disabled:d,filterable:c,maxTagCount:v,bordered:f,clsPrefix:i,ellipsisTagPopoverProps:C,onRender:z,renderTag:p,renderLabel:$}=this;z==null||z();const O=v==="responsive",w=typeof v=="number",b=O||w,k=a(at,null,{default:()=>a(Ft,{clsPrefix:i,loading:this.loading,showArrow:this.showArrow,showClear:this.mergedClearable&&this.selected,onClear:this.handleClear},{default:()=>{var T,S;return(S=(T=this.$slots).arrow)===null||S===void 0?void 0:S.call(T)}})});let V;if(l){const{labelField:T}=this,S=A=>a("div",{class:`${i}-base-selection-tag-wrapper`,key:A.value},p?p({option:A,handleClose:()=>{this.handleDeleteOption(A)}}):a(Qe,{size:s,closable:!A.disabled,disabled:d,onClose:()=>{this.handleDeleteOption(A)},internalCloseIsButtonTag:!1,internalCloseFocusable:!1},{default:()=>$?$(A,!0):Fe(A[T],A,!0)})),P=()=>(w?this.selectedOptions.slice(0,v):this.selectedOptions).map(S),I=c?a("div",{class:`${i}-base-selection-input-tag`,ref:"inputTagElRef",key:"__input-tag__"},a("input",Object.assign({},this.inputProps,{ref:"patternInputRef",tabindex:-1,disabled:d,value:this.pattern,autofocus:this.autofocus,class:`${i}-base-selection-input-tag__input`,onBlur:this.handlePatternInputBlur,onFocus:this.handlePatternInputFocus,onKeydown:this.handlePatternKeyDown,onInput:this.handlePatternInputInput,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd})),a("span",{ref:"patternInputMirrorRef",class:`${i}-base-selection-input-tag__mirror`},this.pattern)):null,E=O?()=>a("div",{class:`${i}-base-selection-tag-wrapper`,ref:"counterWrapperRef"},a(Qe,{size:s,ref:"counterRef",onMouseenter:this.handleMouseEnterCounter,onMouseleave:this.handleMouseLeaveCounter,disabled:d})):void 0;let U;if(w){const A=this.selectedOptions.length-v;A>0&&(U=a("div",{class:`${i}-base-selection-tag-wrapper`,key:"__counter__"},a(Qe,{size:s,ref:"counterRef",onMouseenter:this.handleMouseEnterCounter,disabled:d},{default:()=>`+${A}`})))}const W=O?c?a(dn,{ref:"overflowRef",updateCounter:this.updateCounter,getCounter:this.getCounter,getTail:this.getTail,style:{width:"100%",display:"flex",overflow:"hidden"}},{default:P,counter:E,tail:()=>I}):a(dn,{ref:"overflowRef",updateCounter:this.updateCounter,getCounter:this.getCounter,style:{width:"100%",display:"flex",overflow:"hidden"}},{default:P,counter:E}):w&&U?P().concat(U):P(),oe=b?()=>a("div",{class:`${i}-base-selection-popover`},O?P():this.selectedOptions.map(S)):void 0,ie=b?Object.assign({show:this.showTagsPanel,trigger:"hover",overlap:!0,placement:"top",width:"trigger",onUpdateShow:this.onPopoverUpdateShow,theme:this.mergedTheme.peers.Popover,themeOverrides:this.mergedTheme.peerOverrides.Popover},C):null,J=(this.selected?!1:this.active?!this.pattern&&!this.isComposing:!0)?a("div",{class:`${i}-base-selection-placeholder ${i}-base-selection-overlay`},a("div",{class:`${i}-base-selection-placeholder__inner`},this.placeholder)):null,Y=c?a("div",{ref:"patternInputWrapperRef",class:`${i}-base-selection-tags`},W,O?null:I,k):a("div",{ref:"multipleElRef",class:`${i}-base-selection-tags`,tabindex:d?void 0:0},W,k);V=a(dt,null,b?a(st,Object.assign({},ie,{scrollable:!0,style:"max-height: calc(var(--v-target-height) * 6.6);"}),{trigger:()=>Y,default:oe}):Y,J)}else if(c){const T=this.pattern||this.isComposing,S=this.active?!T:!this.selected,P=this.active?!1:this.selected;V=a("div",{ref:"patternInputWrapperRef",class:`${i}-base-selection-label`,title:this.patternInputFocused?void 0:hn(this.label)},a("input",Object.assign({},this.inputProps,{ref:"patternInputRef",class:`${i}-base-selection-input`,value:this.active?this.pattern:"",placeholder:"",readonly:d,disabled:d,tabindex:-1,autofocus:this.autofocus,onFocus:this.handlePatternInputFocus,onBlur:this.handlePatternInputBlur,onInput:this.handlePatternInputInput,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd})),P?a("div",{class:`${i}-base-selection-label__render-label ${i}-base-selection-overlay`,key:"input"},a("div",{class:`${i}-base-selection-overlay__wrapper`},p?p({option:this.selectedOption,handleClose:()=>{}}):$?$(this.selectedOption,!0):Fe(this.label,this.selectedOption,!0))):null,S?a("div",{class:`${i}-base-selection-placeholder ${i}-base-selection-overlay`,key:"placeholder"},a("div",{class:`${i}-base-selection-overlay__wrapper`},this.filterablePlaceholder)):null,k)}else V=a("div",{ref:"singleElRef",class:`${i}-base-selection-label`,tabindex:this.disabled?void 0:0},this.label!==void 0?a("div",{class:`${i}-base-selection-input`,title:hn(this.label),key:"input"},a("div",{class:`${i}-base-selection-input__content`},p?p({option:this.selectedOption,handleClose:()=>{}}):$?$(this.selectedOption,!0):Fe(this.label,this.selectedOption,!0))):a("div",{class:`${i}-base-selection-placeholder ${i}-base-selection-overlay`,key:"placeholder"},a("div",{class:`${i}-base-selection-placeholder__inner`},this.placeholder)),k);return a("div",{ref:"selfRef",class:[`${i}-base-selection`,this.rtlEnabled&&`${i}-base-selection--rtl`,this.themeClass,e&&`${i}-base-selection--${e}-status`,{[`${i}-base-selection--active`]:this.active,[`${i}-base-selection--selected`]:this.selected||this.active&&this.pattern,[`${i}-base-selection--disabled`]:this.disabled,[`${i}-base-selection--multiple`]:this.multiple,[`${i}-base-selection--focus`]:this.focused}],style:this.cssVars,onClick:this.onClick,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onKeydown:this.onKeydown,onFocusin:this.handleFocusin,onFocusout:this.handleFocusout,onMousedown:this.handleMouseDown},V,f?a("div",{class:`${i}-base-selection__border`}):null,f?a("div",{class:`${i}-base-selection__state-border`}):null)}});function He(e){return e.type==="group"}function Fn(e){return e.type==="ignored"}function Ye(e,l){try{return!!(1+l.toString().toLowerCase().indexOf(e.trim().toLowerCase()))}catch{return!1}}function Ht(e,l){return{getIsGroup:He,getIgnored:Fn,getKey(d){return He(d)?d.name||d.key||"key-required":d[e]},getChildren(d){return d[l]}}}function jt(e,l,s,d){if(!l)return e;function c(v){if(!Array.isArray(v))return[];const f=[];for(const i of v)if(He(i)){const C=c(i[d]);C.length&&f.push(Object.assign({},i,{[d]:C}))}else{if(Fn(i))continue;l(s,i)&&f.push(i)}return f}return c(e)}function Wt(e,l,s){const d=new Map;return e.forEach(c=>{He(c)?c[s].forEach(v=>{d.set(v[l],v)}):d.set(c[l],c)}),d}function Kt(e){const{boxShadow2:l}=e;return{menuBoxShadow:l}}const Ut=nn({name:"Select",common:tn,peers:{InternalSelection:Sn,InternalSelectMenu:Cn},self:Kt}),qt=Ut,Gt=te([R("select",`
 z-index: auto;
 outline: none;
 width: 100%;
 position: relative;
