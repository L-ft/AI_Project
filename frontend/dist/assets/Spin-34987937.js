import{l as S,I as f,n as p,aF as C,O as h,d as x,q as k,s as g,x as m,y as T,bC as $,r as w,aQ as R,z as r,bo as N,ai as O,aW as B,aV as L}from"./index-b97ed927.js";function V(e){const{opacityDisabled:a,heightTiny:t,heightSmall:n,heightMedium:l,heightLarge:s,heightHuge:c,primaryColor:o,fontSize:i}=e;return{fontSize:i,textColor:o,sizeTiny:t,sizeSmall:n,sizeMedium:l,sizeLarge:s,sizeHuge:c,color:o,opacitySpinning:a}}const W={name:"Spin",common:S,self:V},j=W,I=f([f("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
