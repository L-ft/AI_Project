import{l as S,S as f,n as p,aZ as C,L as h,d as x,q as k,s as g,x as m,y as T,aL as $,r as w,aO as R,z as r,bF as L,ah as N,ba as O,aR as B}from"./index-c13886b0.js";function j(e){const{opacityDisabled:a,heightTiny:t,heightSmall:n,heightMedium:l,heightLarge:s,heightHuge:c,primaryColor:o,fontSize:i}=e;return{fontSize:i,textColor:o,sizeTiny:t,sizeSmall:n,sizeMedium:l,sizeLarge:s,sizeHuge:c,color:o,opacitySpinning:a}}const P={name:"Spin",common:S,self:j},V=P,W=f([f("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
