import{l as S,T as f,n as p,aD as C,M as h,d as x,q as T,s as g,x as m,y as k,bs as $,r as w,aP as R,z as r,bT as N,ak as B,aW as L,aV as O}from"./index-a617abee.js";function P(e){const{opacityDisabled:a,heightTiny:t,heightSmall:n,heightMedium:l,heightLarge:s,heightHuge:c,primaryColor:o,fontSize:i}=e;return{fontSize:i,textColor:o,sizeTiny:t,sizeSmall:n,sizeMedium:l,sizeLarge:s,sizeHuge:c,color:o,opacitySpinning:a}}const V={name:"Spin",common:S,self:P},W=V,j=f([f("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
