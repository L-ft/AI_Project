import{l as f,n as p,av as c,p as d,M as o,d as u,q as x,s as v,x as b,y as C,z as s,a4 as $}from"./index-a57f3fe4.js";function w(i){const{textColor1:t,dividerColor:n,fontWeightStrong:l}=i;return{textColor:t,color:n,fontWeight:l}}const _={name:"Divider",common:f,self:w},y=_,z=p("divider",`
 position: relative;
 display: flex;
 width: 100%;
