import{l as S,T as f,n as p,b1 as C,M as h,d as x,q as T,s as g,x as m,y as k,aP as $,r as w,aS as R,z as r,bJ as N,aj as j,be as B,aV as L}from"./index-046e80b1.js";function O(e){const{opacityDisabled:a,heightTiny:t,heightSmall:n,heightMedium:l,heightLarge:s,heightHuge:c,primaryColor:o,fontSize:i}=e;return{fontSize:i,textColor:o,sizeTiny:t,sizeSmall:n,sizeMedium:l,sizeLarge:s,sizeHuge:c,color:o,opacitySpinning:a}}const P={name:"Spin",common:S,self:O},V=P,W=f([f("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
