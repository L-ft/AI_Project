import{l as T,d as B,x as v,z as r,V as D,b4 as O,b5 as j,b6 as q,b7 as L,b8 as A,$ as k,I as z,n as a,O as w,q as M,s as G,y as X,aV as N}from"./index-b97ed927.js";function Y(e){const{infoColor:d,successColor:u,warningColor:f,errorColor:c,textColor2:i,progressRailColor:t,fontSize:n,fontWeight:g}=e;return{fontSize:n,fontSizeCircle:"28px",fontWeightCircle:g,railColor:t,railHeight:"8px",iconSizeCircle:"36px",iconSizeLine:"18px",iconColor:d,iconColorInfo:d,iconColorSuccess:u,iconColorWarning:f,iconColorError:c,textColorCircle:i,textColorLineInner:"rgb(255, 255, 255)",textColorLineOuter:i,fillColor:d,fillColorInfo:d,fillColorSuccess:u,fillColorWarning:f,fillColorError:c,lineBgProcessing:"linear-gradient(90deg, rgba(255, 255, 255, .3) 0%, rgba(255, 255, 255, .5) 100%)"}}const _={name:"Progress",common:T,self:Y},H=_,V={success:r(O,null),error:r(j,null),warning:r(q,null),info:r(L,null)},E=B({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:d}){const u=v(()=>{const i="gradient",{fillColor:t}=e;return typeof t=="object"?`${i}-${A(JSON.stringify(t))}`:i});function f(i,t,n,g){const{gapDegree:p,viewBoxWidth:h,strokeWidth:y}=e,l=50,b=0,s=l,o=0,x=2*l,C=50+y/2,m=`M ${C},${C} m ${b},${s}
 ...
 `)]),Q=Object.assign(Object.assign({},G.props),{processing:Boolean,type:{type:String,default:"line"},gapDegree:Number,gapOffsetDegree:Number,status:{type:String,default:"default"},railColor:[String,Array],railStyle:[String,Array],color:[String,Array,Object],viewBoxWidth:{type:Number,default:100},strokeWidth:{type:Number,default:7},percentage:[Number,Array],unit:{type:String,default:"%"},showIndicator:{type:Boolean,default:!0},indicatorPosition:{type:String,default:"outside"},indicatorPlacement:{type:String,default:"outside"},indicatorTextColor:String,circleGap:{type:Number,default:1},height:Number,borderRadius:[String,Number],fillBorderRadius:[String,Number],offsetDegree:Number}),ee=B({name:"Progress",props:Q,setup(e){const d=v(()=>e.indicatorPlacement||e.indicatorPosition),u=v(()=>{if(e.gapDegree||e.gapDegree===0)return e.gapDegree;if(e.type==="dashboard")return 75}),{mergedClsPrefixRef:f,inlineThemeDisabled:c}=M(e),i=G("Progress","-progress",Z,H,e,f),t=v(()=>{const{status:g}=e,{common:{cubicBezierEaseInOut:p},self:{fontSize:h,fontSizeCircle:y,railColor:l,railHeight:b,iconSizeCircle:s,iconSizeLine:o,textColorCircle:x,textColorLineInner:C,textColorLineOuter:m,lineBgProcessing:$,fontWeightCircle:S,[N("iconColor",g)]:R,[N("fillColor",g)]:P}}=i.value;return{"--n-bezier":p,"--n-fill-color":P,"--n-font-size":h,"--n-font-size-circle":y,"--n-font-weight-circle":S,"--n-icon-color":R,"--n-icon-size-circle":s,"--n-icon-size-line":o,"--n-line-bg-processing":$,"--n-rail-color":l,"--n-rail-height":b,"--n-text-color-circle":x,"--n-text-color-line-inner":C,"--n-text-color-line-outer":m}}),n=c?X("progress",v(()=>e.status[0]),t,e):void 0;return{mergedClsPrefix:f,mergedIndicatorPlacement:d,gapDeg:u,cssVars:c?void 0:t,themeClass:n==null?void 0:n.themeClass,onRender:n==null?void 0:n.onRender}},render(){const{type:e,cssVars:d,indicatorTextColor:u,showIndicator:f,status:c,railColor:i,railStyle:t,color:n,percentage:g,viewBoxWidth:p,strokeWidth:h,mergedIndicatorPlacement:y,unit:l,borderRadius:b,fillBorderRadius:s,height:o,processing:x,circleGap:C,mergedClsPrefix:m,gapDeg:$,gapOffsetDegree:S,themeClass:R,$slots:P,onRender:I}=this;return I==null||I(),r("div",{class:[R,`${m}-progress`,`${m}-progress--${e}`,`${m}-progress--${c}`],style:d,"aria-valuemax":100,"aria-valuemin":0,"aria-valuenow":g,role:e==="circle"||e==="line"||e==="dashboard"?"progressbar":"none"},e==="circle"||e==="dashboard"?r(E,{clsPrefix:m,status:c,showIndicator:f,indicatorTextColor:u,railColor:i,fillColor:n,railStyle:t,offsetDegree:this.offsetDegree,percentage:g,viewBoxWidth:p,strokeWidth:h,gapDegree:$===void 0?e==="dashboard"?75:0:$,gapOffsetDegree:S,unit:l},P):e==="line"?r(J,{clsPrefix:m,status:c,showIndicator:f,indicatorTextColor:u,railColor:i,fillColor:n,railStyle:t,percentage:g,processing:x,indicatorPlacement:y,unit:l,fillBorderRadius:s,railBorderRadius:b,height:o},P):e==="multiple-circle"?r(K,{clsPrefix:m,strokeWidth:h,railColor:i,fillColor:n,railStyle:t,viewBoxWidth:p,percentage:g,showIndicator:f,circleGap:C},P):null)}});export{ee as N,H as p};
