import{n as k,$ as A,H as h,_ as u,p as s,d as a,q as P,I as be,T as J,v as Q,z as H,b8 as ge,l as ve,b9 as q,L as fe,M as pe,aF as X,r as F,O as K,a0 as Z,as as Y,R as T,s as U,x as I,y as ee,A as we,a6 as E,ba as xe,bb as me,o as b,c as g,a as d}from"./index-7f2fca7f.js";const n="0!important",oe="-1px!important";function V(e){return u(`${e}-type`,[h("& +",[k("button",{},[u(`${e}-type`,[s("border",{borderLeftWidth:n}),s("state-border",{left:oe})])])])])}function D(e){return u(`${e}-type`,[h("& +",[k("button",[u(`${e}-type`,[s("border",{borderTopWidth:n}),s("state-border",{top:oe})])])])])}const _e=k("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
