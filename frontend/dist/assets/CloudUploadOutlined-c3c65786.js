import{l as G,d as P,x as b,z as r,T as D,bl as O,bm as j,bn as q,bo as _,bp as M,_ as k,S as B,n as a,L as w,q as A,s as L,y as H,aR as I,o as X,c as V,a as T}from"./index-c333c3f8.js";function Y(e){const{infoColor:d,successColor:g,warningColor:p,errorColor:c,textColor2:o,progressRailColor:t,fontSize:n,fontWeight:u}=e;return{fontSize:n,fontSizeCircle:"28px",fontWeightCircle:u,railColor:t,railHeight:"8px",iconSizeCircle:"36px",iconSizeLine:"18px",iconColor:d,iconColorInfo:d,iconColorSuccess:g,iconColorWarning:p,iconColorError:c,textColorCircle:o,textColorLineInner:"rgb(255, 255, 255)",textColorLineOuter:o,fillColor:d,fillColorInfo:d,fillColorSuccess:g,fillColorWarning:p,fillColorError:c,lineBgProcessing:"linear-gradient(90deg, rgba(255, 255, 255, .3) 0%, rgba(255, 255, 255, .5) 100%)"}}const E={name:"Progress",common:G,self:Y},F=E,U={success:r(O,null),error:r(j,null),warning:r(q,null),info:r(_,null)},J=P({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:d}){const g=b(()=>{const o="gradient",{fillColor:t}=e;return typeof t=="object"?`${o}-${M(JSON.stringify(t))}`:o});function p(o,t,n,u){const{gapDegree:f,viewBoxWidth:h,strokeWidth:y}=e,l=50,m=0,s=l,i=0,x=2*l,C=50+y/2,v=`M ${C},${C} m ${m},${s}
      a ${l},${l} 0 1 1 ${i},${-x}
