                      ...
                      <Teleport to="body">
                        <Transition name="step-detail-panel">
                          <div v-if="detailStepCount > 0 && stepDetailDrawerVisible" class="step-detail-fixed-drawer">
                            ...
                            <aside class="step-side-stack">
                              <div class="step-overview-card step-overview-card--side">
                                <div class="step-overview-head">
                                  <div class="step-overview-title-group">
                                    <span class="step-overview-eyebrow">步骤概览</span>
                                    <div class="step-overview-title-line">
...
.step-link-btn.primary {
  border-color: #7d33ff;
  background: linear-gradient(180deg, rgba(255, 255, 255, 0.98) 0%, rgba(125, 51, 255, 0.1) 100%);
  color: #7d33ff;
}
.step-link-btn.muted {
  color: #64748b;
...
.step-stat-card.fail {
  background: linear-gradient(180deg, rgba(253, 249, 250, 0.94) 0%, rgba(255, 255, 255, 0.98) 100%);
}
.step-stat-card.fail::before {
  background: #f2b4bd;
}
.step-stat-card.pending {
  background: linear-gradient(180deg, rgba(249, 251, 254, 0.94) 0%, rgba(255, 255, 255, 0.98) 100%);
}
